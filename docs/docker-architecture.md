...
- [Docker Mode User Guide](docker-mode.md) — how to scaffold, boot, upgrade, and troubleshoot.
- [Adding an MCP (Docker)](adding-an-mcp-docker.md) — extending the agent with custom MCPs in Docker mode.
